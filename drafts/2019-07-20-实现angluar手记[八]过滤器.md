...
How you can register several filters in bulk by giving the filter service an object. How filter expressions are processed as call expressions by the AST builder and compiler.
