---
layout: fexo
title: "leetcode[4]求两个已排序的数组的中位数"
date: 2019-09-14T22:48:42.000Z
tags:
  - algorithms
permalink: 2019-09-13-leetcode-4-median-of-two-sorted-arrays
---
...
var findMedianSortedArrays = function(nums1, nums2) {
  ...
  while (low <= high) {
    ...
    let maxLeft2 = j === 0 ? -Infinity : nums1[j - 1];
    let minRight2 = i === len2 ? Infinity : nums1[j];
